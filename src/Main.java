...
public class Main extends Application {
    public static void main(String[] args) {
        //array of string to store menu items
        String[][] menuItems = {
        ...
        //array of string to store employees data
        ...
        //url to your local host, dont forget to turn your server on to allow connection
        String url = "jdbc:mysql://localhost";
        //local server username and password, might be different if set by user
        String user = "root";
