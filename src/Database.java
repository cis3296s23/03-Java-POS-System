...
public class Database {
    private Connection connection;  //initialize database connection
    private String[][] menuItems;   //array of string to store all menu items
    private String[][] employees;   //array of string to store employees data
    ...
    //this will create a database called data and insert data into different tables
